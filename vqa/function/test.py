...
def test_net(args, config, ckpt_path=None, save_path=None, save_name=None):
    ...
    # loader
    test_loader = make_dataloader(config, mode='test', distributed=False, lang=args.lang, data=args.data) #demo
    ...
    '''
    if args.data == 'demo':
        result = [test_dataset.answer_vocab[a_id] for a_id in answer_ids]
        return result
    else:
    '''
